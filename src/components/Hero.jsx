  ...
  return (
    <section id="hero">
      <div className="flex flex-col items-center">
        ...
        <img id="hero-img" src="/title2.png" alt="Türkiye Gazetesi" className="-mt-40 md:-mt-55 relative z-0 opacity-0 translate-y-10" />
      </div>
      <video src="/videos/hero.mp4" autoPlay muted playsInline className="-mt-10 md:-mt-32 relative z-10" />
